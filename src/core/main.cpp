...
const float CANUpdateLoopPeriodInms = 1.0; /*!< Define the CAN PDO sync message period (and so PDO update rate). In ms. Less than 3 can lead to unstable communication  */
