...
void X2DemoMachine::init(int argc, char *argv[]) {
    ...
    logHelper.add(robot_->getCorrectedContactAccelerationsZ_(), "Acceleration");
    logHelper.add(robot_->getFilteredCorrectedContactAccelerationsZ_(), "FilteredAcceleration");
